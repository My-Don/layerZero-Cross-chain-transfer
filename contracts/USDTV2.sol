...
contract USDT is Context, IBEP20, Ownable {
  ...
  mapping(address => bool) public minterBurners;
  ...
  modifier onlyMinterBurner() {
    require(minterBurners[msg.sender], "not authorized");
    _;
}
  ...
  */
  ...
  function setMinterBurner(address addr, bool ok) external onlyOwner {
    minterBurners[addr] = ok;
  }
